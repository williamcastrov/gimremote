...
*/
  ...
  const [valorHorometroActual, setValorHorometroActual] = useState(0);
  ...
  useEffect(() => {
    async function fetchDataValorHorometro() {
      //console.log("CODIGO EQUI : ", equipo_otr)
      const res = await datoshorometroServices.listUnDatoHorometro(equipo_otr);
      setValorHorometroActual(res.data[0].valorhorometro_dhr);
      //console.log("VALOR HOROMTERO ACTUAl : ", res.data[0].valorhorometro_dhr)
    }
    fetchDataValorHorometro();
  }, [])
...
*/
  ...
  useEffect(() => {
    async function grabarValorHorometro() {
      ...
      if (controlHorometro) {
        ...
        //console.log("HOROMETRO ACTIVIDAD : ", horometroActividad[0])
  ...
  const grabarHorometro = (
    <div className="App">
      <Title align="center" type="warning" level={4}>
        VALOR HOROMETRO ACTUAL {valorHorometroActual}
      </Title>
      <Title align="center" type="warning" level={4}>
